                ...
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                        ...
                        <a href="" class="cat-img position-relative overflow-hidden mb-3">
                            <img class="{{asset($cat->photoCat)}}" src="storage/img/{{$cat->photoCat}}" alt="">
                        </a>
                        <h5 class="font-weight-semi-bold m-0">{{$cat->nomCat}}</h5>
                    </div>
                </div>
                @if ($loop->iteration % 3 == 0) </div><div class="row px-xl-5 pb-3"> @endif
            @endforeach
        </div>
    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" src="{{ asset($prod->photo) }}" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">{{$prod->nomPro}}</h6>
                        <div class="d-flex justify-content-center">
                            <h6>{{$prod->prixPro}}</h6><h6 class="text-muted ml-2"><del>{{$prod->prixPro+25}}</del></h6>
                        </div>
                    </div>
